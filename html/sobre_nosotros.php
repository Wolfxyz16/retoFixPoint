    ...
    <main>
        ...
        <div id="que-es">
            ...
            <div id="que-es-contenido">
                <p>
                    FixPoint es la primera Biblioteca de préstamo de España. Las Bibliotecas de herramientas funcionan
                    como cualquier otra Biblioteca. Te conviertes en miembro y luego puedes tomar prestadas
                    herramientas. No tenemos fines de lucro y buscamos ser una organización benéfica. Los objetivos son
                    simples:
                </p>
                <ul>
                    <li>
                        Promover las habilidades de bricolaje, fabricación y reparación mediante el intercambio de
                        herramientas
                    </li>
                    <li>
        ...
        <div class="img_con_texto">
            ...
            <div class="mensaje">
                ...
                <p class="texto">
                    ...
                    debemos facilitar que 'acceder a' sea m&aacute;s f&aacute;cil, m&aacute;s barato y más divertido que
                    'poseer'.
                </p>
            </div>
        </div>
        ...
        <div class="img_con_texto">
            ...
            <div class="mensaje">
                ...
                <p class="texto">
                    ...
                    ineficiencia resultante, la comunicación la desigualdad (social). La misión de FixPoint es
